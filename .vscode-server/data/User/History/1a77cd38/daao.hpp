...
public:
    ...
    *   @return None
     */    
     uint32_t Insertion(VEBTree** parentNode , uint32_t valueToInsert, uint32_t counter);
    ...
    *   @return None
    * */
     uint32_t Removal( uint32_t valueToFind, VEBTree** parentNode, uint32_t counter);
