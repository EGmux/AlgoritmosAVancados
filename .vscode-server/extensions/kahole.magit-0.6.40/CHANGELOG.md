...
- expose toggle fold command in command pallete, fixing [#229](https://github.com/kahole/edamagit/issues/229)
...
- Ask if should stage all when committing with no staged changes (fixes [#140](https://github.com/kahole/edamagit/issues/140))
