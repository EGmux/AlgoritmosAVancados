...
- Added support for including VS Code `command:` links within your tour step comments (e.g. `[Start Tour](https://github.com/microsoft/codetour/blob/HEAD/command:codetour.startTour)`), in order to automate arbitrary workbench actions.
