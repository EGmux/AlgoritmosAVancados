...
- Documentation:
  - Added 'API' section to [DESIGN.md](https://github.com/tshino/vscode-kb-macro/blob/HEAD/DESIGN.md).
...
- Documentation:
  - Added 'Dealing with re-entrance' section to [DESIGN.md](https://github.com/tshino/vscode-kb-macro/blob/HEAD/DESIGN.md).
- Internal:
...
### [0.12.1] - 2022-05-07
- Documentation:
  - Added 'Testing' section to [DESIGN.md](https://github.com/tshino/vscode-kb-macro/blob/HEAD/DESIGN.md).
- Update
...
- Documentation:
  ...
  - Added 'Keymap wrappers' section to [DESIGN.md](https://github.com/tshino/vscode-kb-macro/blob/HEAD/DESIGN.md).
- Update
...
- Update
  ...
  - Updated [DESIGN.md](https://github.com/tshino/vscode-kb-macro/blob/HEAD/DESIGN.md).
- Fix
...
### [0.8.0] - 2022-01-01
- New
  - Added Delphi Keymap support. (See [Keymap Wrappers](https://github.com/tshino/vscode-kb-macro/blob/HEAD/keymap-wrapper/README.md)) [#23](https://github.com/tshino/vscode-kb-macro/pull/23)
  - Added Visual Studio Keymap support. (See [Keymap Wrappers](https://github.com/tshino/vscode-kb-macro/blob/HEAD/keymap-wrapper/README.md)) [#24](https://github.com/tshino/vscode-kb-macro/pull/24)
  - Added emacs-style prefix-arguments support through the keymap wrapper for Awesome Emacs Keymap. (See [Keymap Wrappers](https://github.com/tshino/vscode-kb-macro/blob/HEAD/keymap-wrapper/README.md)) [#25](https://github.com/tshino/vscode-kb-macro/pull/25)
...
### [0.7.0] - 2021-12-26
- New
  - Added Atom Keymap support. (See [Keymap Wrappers](https://github.com/tshino/vscode-kb-macro/blob/HEAD/keymap-wrapper/README.md)) [#22](https://github.com/tshino/vscode-kb-macro/pull/22)
  - Added Notepad++ Keymap support. (See [Keymap Wrappers](https://github.com/tshino/vscode-kb-macro/blob/HEAD/keymap-wrapper/README.md)) [#21](https://github.com/tshino/vscode-kb-macro/pull/21)
...
### [0.6.0] - 2021-12-19
- New
  - Added Sublime Text Keymap support. (See [Keymap Wrappers](https://github.com/tshino/vscode-kb-macro/blob/HEAD/keymap-wrapper/README.md)) [#18](https://github.com/tshino/vscode-kb-macro/issues/18)
...
### [0.4.0] - 2021-12-10
- New
  - Added [a list of recommended keymap wrappers](https://github.com/tshino/vscode-kb-macro/blob/HEAD/keymap-wrapper/README.md).
